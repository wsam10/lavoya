    ...
    <>
      ...
      >
        <div className="relative w-full">
          <div className="flex items-center justify-between mx-auto max-w-7xl px-4 sm:px-6 md:px-0">
            ...
            <div className=" flex items-center justify-between  w-auto px-0 mt-8 md:mt-0">
              ...
              <div className="mx-auto  px-3 py-2">
                ...
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center dark:bg-[#0F1014] bg-white text-body-color duration-300 dark:text-white rounded-lg p-5"
                >
                  <span>
                    <svg
                      viewBox="0 0 16 16"
              ...
              <div className="mx-auto  px-3 py-1">
                <button
                  ...
                  className="block dark:bg-[#0F1014] bg-white rounded-lg px-3 py-[6px] "
                >
                  <span
