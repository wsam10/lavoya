        ...
        <Parallax speed={10}>
          <div className="group relative mt-0 inline-flex">
            ...
            >
              ...
              <span className="block rounded-lg bg-[#FDB940] px-12 py-3 transition-transform  group-hover:text-dark group-hover:-translate-x-2 group-hover:-translate-y-2">
                EXPLORE MORE
              </span>
            </a>
            <div className="-scale-x-100 absolute left-0 -bottom-14 lg:-bottom-10 h-10 w-10 -rotate-12 dark:text-[#ffffff] text-dark md:inline-flex">
